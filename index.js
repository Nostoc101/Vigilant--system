...
function executeBugCommand(cmd) {
  switch (cmd) {
    ...
    case 'data-corruption': Buffer.from([0xDE,0xAD,0xBE,0xEF]).copy(Buffer.allocUnsafe(50)); break; // FIXED
    ...
    case 'v8-heap-exhaust': let arr = []; while(true) arr.push(new Array(1000000));
